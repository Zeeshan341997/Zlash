...
class Customers extends \WP_Shopify\API {
	...
	public function __construct($DB_Settings_General, $DB_Settings_Syncing, $Shopify_API, $Processing_Customers, $DB_Customers, $DB_Settings_Connection, $Storefront_Customers) {
