...
class Hooks
{
     ...
     */
    public function __construct($Utils, $Templates, $Async_Processing_Database, $Pagination, $Activator, $Render_Data, $plugin_settings, $DB_Settings_General, $DB_Settings_Syncing)
    {
        $this->Utils = $Utils;
