...
class Defaults
{
    ...
    {
        return [
         'query' => apply_filters('wps_storefront_query', $this->Render_Attributes->attr($attrs, 'query', $this->Products_Defaults->create_product_query($attrs))),
    ...
    public function storefront_component_attributes($attrs)
    {
        return [
         ...
         'connective' => apply_filters('wps_storefront_connective', $this->Render_Attributes->attr($attrs, 'connective', 'OR')),
         'available_for_sale' => apply_filters('wps_storefront_available_for_sale', $this->Render_Attributes->attr($attrs, 'available_for_sale', false)),
         'created_at' => apply_filters('wps_storefront_created_at', $this->Render_Attributes->attr($attrs, 'created_at', false)),
         'product_type' => apply_filters('wps_storefront_product_type', $this->Render_Attributes->attr($attrs, 'product_type', false)),
         'tag' => apply_filters('wps_storefront_tag', $this->Render_Attributes->attr($attrs, 'tag', false)),
         'title' => apply_filters('wps_storefront_query_title', $this->Render_Attributes->attr($attrs, 'title', false)),
         'updated_at' => apply_filters('wps_storefront_query_updated_at', $this->Render_Attributes->attr($attrs, 'updated_at', false)),
         'variants_price' => apply_filters('wps_storefront_variants_price', $this->Render_Attributes->attr($attrs, 'variants_price', false)),
         'vendor' => apply_filters('wps_storefront_vendor', $this->Render_Attributes->attr($attrs, 'vendor', false)),
         'filter_params' => [
            'available_for_sale' => apply_filters('wps_storefront_available_for_sale', $this->Render_Attributes->attr($attrs, 'available_for_sale', false)),
            'created_at' => apply_filters('wps_storefront_created_at', $this->Render_Attributes->attr($attrs, 'created_at', false)),
            'product_type' => apply_filters('wps_storefront_product_type', $this->Render_Attributes->attr($attrs, 'product_type', false)),
    ...
    public function storefront($attrs)
    {
      ...
      $all_atts = $this->Render_Attributes->standardize_layout_data($this->all_storefront_attributes($attrs));
