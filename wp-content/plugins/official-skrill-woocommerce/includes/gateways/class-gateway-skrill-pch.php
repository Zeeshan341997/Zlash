...
class Gateway_Skrill_PCH extends Skrill_Payment_Gateway {
	 ...
	 * @var array
	 */
	protected $allowed_countries = array( 'AUT','HRV','HUN','ITA','MLT','PRT','ROU','SVN','ESP' );
	 ...
	 * @var string
	 */
	public $payment_method_description = 'Austria, Croatia, Hungary, Italy, Malta, Portugal, Romania, Slovenia, Spain';
