...
class Gateway_Skrill_OBT extends Skrill_Payment_Gateway {
	 ...
	 * @var array
	 */
	protected $allowed_countries = array( 'AUT', 'DNK', 'FIN', 'FRA', 'DEU', 'HUN', 'ITA', 'NOR', 'POL', 'PRT', 'ESP', 'SWE', 'GBR' );
	 ...
	 * @var string
	 */
	public $payment_method_description = 'Austria, Denmark, Finland, France, Germany,
